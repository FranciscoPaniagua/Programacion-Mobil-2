package lopez.acosta.contactosapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String getNombre(Uri uri){
        ...
        Cursor c=contentResolver.query(uri,new String[]{Contacts.DISPLAY_NAME},null,null,null);
        if(c.moveToFirst()){
    ...
    private String getTelefono(Uri uri){
        ...
        Cursor contactoCursor=getContentResolver().query(uri,new String[]{Contacts._ID},null,null,null);
        if(contactoCursor.moveToFirst()){
            id=contactoCursor.getString(0);
        }
        contactoCursor.close();
        String selectionArgs=CommonDataKinds.Phone.CONTACT_ID+" = ? AND "+ CommonDataKinds.Phone.TYPE+" = "+CommonDataKinds.Phone.TYPE_MOBILE;
        Cursor telefonoCursor=getContentResolver().query(CommonDataKinds.Phone.CONTENT_URI,new String[]{CommonDataKinds.Phone.NUMBER},selectionArgs,new String[]{id},null);
